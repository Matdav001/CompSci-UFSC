...
## Continuidade (Definição Intuitiva)
...
| ![Continuos graph 01](/FirstSemester/MTM3110/Notes/LimitsImages/Continuos01.png) | ![Non continuos graph](/FirstSemester/MTM3110/Notes/LimitsImages/NonContinuos01.png) | ![Continuos graph 02](/FirstSemester/MTM3110/Notes/LimitsImages/Continuos02.png) |
| :-: | :-: | :-: |
| $f$ é contínua em $x_o$ | $f$ não é contínua em $x_o$ | $f$ é contínua em $x_o$ |

## Limite (Definição Intuitiva)
